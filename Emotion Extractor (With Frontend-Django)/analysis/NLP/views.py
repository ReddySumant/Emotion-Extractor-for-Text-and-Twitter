...
def result(request):
    if request.method == 'GET':
        ...
        plt.savefig('c:/Users/THUGanomics/Desktop/Web- Sntimental Analysis/analysis/statics/Text1Analysis.png')
        plt.close()
...
def result2(request):
    if request.method == 'GET':  
        ...
        def TweetAnalysis():
            ...
            plt.savefig('c:/Users/THUGanomics/Desktop/Web- Sntimental Analysis/analysis/statics/graph.png')
            plt.close()
        ...
        def Tweetpie():
            class SentimentAnalysis:
                ...
                def plotPieChart(self, positive, wpositive, spositive, negative, wnegative, snegative, neutral, searchTerm, noOfSearchTerms):
                    ...
                    plt.axis('equal')
                    plt.tight_layout()
                    plt.savefig('c:/Users/THUGanomics/Desktop/Web- Sntimental Analysis/analysis/statics/Tweet2Pie.png')
                    plt.close()
